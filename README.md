...
* `run_star`
  ...
  * The walltime in `run_star.sbatch` will need to be adjusted depending on the size of your data. For example, it took approximately 25 minutes for this script to process a 3.0 GB folder.
